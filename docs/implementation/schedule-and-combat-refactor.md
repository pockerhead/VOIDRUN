...
- [ ] Протестировано (spawn + movement)

### Фаза 2: Schedule Refactoring 🎯
- [ ] FixedUpdate изменён с 64 Hz → 60 Hz
- [ ] FixedTickCounter resource создан
- [ ] CombatUpdate schedule создан
- [ ] Timer systems реализованы (exclusive)
- [ ] Systems зарегистрированы в FixedUpdate
- [ ] SlowUpdateTimer удалён (старый код)
- [ ] Протестировано (AI работает как раньше)
